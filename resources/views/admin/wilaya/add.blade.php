...
@section('content')
 <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">AJOUTER UNE WILAYA</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
        ...
        <div class="col-12">
          <div class="card">
             <div class="card-header row">
              <h3 class="card-title col-md-12">AJOUTER UNE WILAYA</h3>
             </div>
           {!!Form::open(['url' => '/admin/wilaya' ,'method' => 'post'])!!}
                  <div class="row">
                    <div class="col-md-8 form-group">
                      <label for="wilaya">WILAYA</label>
                      <input id="wilaya" type="text" class="form-control form-control-lg @error('wilaya') is-invalid @enderror" name="wilaya" value="{{ old('wilaya') }}" required autocomplete="wilaya" autofocus>
