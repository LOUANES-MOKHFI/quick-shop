            ...
            <div class="row">
                ...
                <div class="col-lg-9 col-md-7">
                    <div class="product__discount">
                       @if($_SERVER['REQUEST_URI'] == '/all-products')

                        <div class="section-title product__discount__title">
                            <h2>REMISES</h2>
                            <p class="right" style="float: right;font-size: 17px;color: blue">{{count(New_Product_promo())}} produit(s) en promotion</p>
                        </div>
                         @if(count(New_Product_promo()) == 0)
                   
                        
                          <div class="col-lg-12 col-md-12 col-sm-12 text-center">
                            <div class="product__item">
                               <h4 style="color: red">LA LISTE DES PRODUITS EN PROMOTION EST VIDE</h4>
                            </div>
                        </div>
                        @else
                        <div class="row">
                            <div class="product__discount__slider owl-carousel">
                                @foreach(New_Product_promo() as $product)
                                <div class="col-lg-4">
                                    <div class="product__discount__item">
                                        <div class="product__discount__item__pic set-bg"
                                            data-setbg="{{asset('/product/'.$product->image_principale)}}">
                                            <div class="product__discount__percent">PROMO</div>
                        ...
                        <div class="section-title product__discount__title text-center" >
                            <h5 class="remise"><a href="{{url('/all-products-in-promo')}}"> Voir plus des remises</a></h5>
                        </div>
                               @endif
                    @endif
